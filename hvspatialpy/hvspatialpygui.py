...
class HVSpatialPYGui:
    ...
    def __init__(self):
        ...
        self.base_dir_widget = widgets.Text(
            ...
            value='C:/Users/Javier Ornelas/OneDrive/Documents/HVSRdata_Main/mHVSR Site Inv/VSPDB Data/CA Vertical Array Data/HVSRdata',
        ...
        self.correlation_type_widget = widgets.Dropdown(
            options=['lcss', 'dtw', 'pearson', 'spearman', 'mae', 'mse', 'euclidean', 'sqeuclidean', 'braycurtis',
                     'canberra',
                     'chebyshev', 'cityblock', 'correlation', 'cosine', 'jensenshannon', 'minkowski', 'dice',
                     'hamming', 'jaccard', 'kulczynski1', 'rogerstanimoto', 'russellrao', 'sokalmichener',
                     'sokalsneath', 'yule'],
            value='lcss',
    ...
    def on_button_click(self, b):
        with self.output_widget:
            ...
            output1, output2, output3 = update_correlations(base_dir=self.base_dir_widget.value,
            ...
            output1_path = os.path.join(save_dir, 'frequency_interval_df.csv')
            output2_path = os.path.join(save_dir, 'correlation_df.csv')
            ...
            output3.savefig(figdir, dpi=500)
